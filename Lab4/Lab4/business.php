<?php 
	$db = mysqli_connect("localhost", "root", "", "test", "3306");
?> 
<!DOCTYPE html>
<html>
<head>
...
<div class="right">
	<form name="myForm" id="myForm" action="business.php" method="POST">
...
<?php 
	if(array_key_exists("name", $_POST)){
		...
		$query = "insert into info(name, adress, city, telephone, url)
					value (
		...
		$query = "select id from info where name = '$name' and adress = '$adress'";
